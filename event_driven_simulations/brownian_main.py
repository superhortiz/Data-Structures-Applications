...
def main() -> None:
    ...
    for _ in range(200):
        ...
        radius = 5
        particles.append(Particle(position, velocity, radius, DARK_PURPLE, BOX_WIDTH, BOX_HEIGHT))

    particles.append(Particle(np.array([BOX_WIDTH//2, BOX_HEIGHT//2]), np.array([0, 0]), 35, PURPLE, BOX_WIDTH, BOX_HEIGHT, 0.1))
