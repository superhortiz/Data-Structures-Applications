    ...
    def run(self) -> None:
        ...
        while running:
            ...
            for body in self.bodies:
                ...
                pygame.draw.circle(glow_surface, (*body.color, 128), (int(body.position[0]), int(body.position[1])),
                    body.diameter * 1.25)
...
def main() -> None:
    ...
    """
    bodies = [
        Body([WIDTH / 2 - distance / 2, HEIGHT / 2], [0, velocity], mass, np.random.randint(50,255,3), 10),
        Body([WIDTH / 2 + distance / 2, HEIGHT / 2], [0, -velocity], mass, np.random.randint(50,255,3), 10),
        Body([WIDTH / 2, HEIGHT / 2 + distance / 2], [velocity, 0], mass, np.random.randint(50,255,3), 10),
        Body([WIDTH / 2, HEIGHT / 2 - distance / 2], [-velocity, 0], mass, np.random.randint(50,255,3), 10),
    ]
